...
<style type="text/css">
	...
	<body>
		...
		<div id="show_box">
			<img id = "img01" src="http://localhost:8081/JSP01/drawThrowBox?cmd=drawImage&width=1000&height=500&posX=50&posY=300"/>
		</div>
		...
		<script type="text/javascript">
			...
			function setImage ( id, width, height, posX, posY ){
				...
				var img = "http://localhost:8081/JSP01/drawThrowBox?cmd=drawImage"

...
<script type="text/javascript">
	...
	function getImage( x_val, y_val ){
		...
		var img = "http://localhost:8081/JSP01/drawDropBox?cmd=drawImage&x_pos="+x_pos+"&y_pos=" + y_pos;
		$( "#img01" ).attr( "src" , img );
	}
...
<body>
	...
	<form id="frm" action="/JSP01/drawDropBox" method="GET">
	...
	<div id="show_box">
		...
		<img id = "img01" src="http://localhost:8081/JSP01/drawDropBox?cmd=drawImage&x_pos=0&y_pos=0"/>

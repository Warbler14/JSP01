...
<script type="text/javascript">
	...
	function getImage(){
		...
		for(var i = 0 , ii = 10 ; i<ii ; i++ ){
			for(var j = 0 , jj = 10 ; j<jj ; j++ ){
				
				
				var img = "http://localhost:8081/JSP01/drawRandomColor?cmd=drawImage&color=" + getRandomColor();
...
<body>
	...
	<form id="frm" action="/JSP01/drawRandomColor" method="GET">
				...
				<c:forEach var="j" begin="0" end="9" step="1">
					<td id="div_${i}_${j}">
						<div class="box">
							...
							<img id = "img_${i}_${j}" src="http://localhost:8081/JSP01/drawRandomColor?cmd=drawImage&color=${rand1}_${rand2}_${rand3}"/>
						</div>
					</td>
				</c:forEach>
				</tr>

...
public class CommandLoader023 implements CommandLoader{
	static Logger logger = Logger.getLogger(CommandLoader023.class);
	
	private String move_page [][] ;
	private String parameters [] ;
	
	public CommandLoader023( String [][] move_page, String [] parameters ){

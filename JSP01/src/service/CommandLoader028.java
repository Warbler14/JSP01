...
public class CommandLoader028 implements CommandLoader{
	static Logger logger = Logger.getLogger(CommandLoader028.class);
	
	private String move_page [][] ;
	private String parameters [] ;
	
	public CommandLoader028( String [][] move_page, String [] parameters ){

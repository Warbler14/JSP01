...
public class CommandLoader027 implements CommandLoader{
	static Logger logger = Logger.getLogger(CommandLoader027.class);
	
	private String move_page [][] ;
	private String parameters [] ;
	
	public CommandLoader027( String [][] move_page, String [] parameters ){

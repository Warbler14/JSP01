...
public class CommandLoader025 implements CommandLoader{
	static Logger logger = Logger.getLogger(CommandLoader025.class);
	
	private String move_page [][] ;
	private String parameters [] ;
	
	public CommandLoader025( String [][] move_page, String [] parameters ){

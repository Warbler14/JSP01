...
public class CommandLoader024 implements CommandLoader{
	static Logger logger = Logger.getLogger(CommandLoader024.class);
	
	private String move_page [][] ;
	private String parameters [] ;
	
	public CommandLoader024( String [][] move_page, String [] parameters ){
	...
	private static void paintProcessJPG( HttpServletRequest request, HttpServletResponse response
		...
		g.setPaint(baseColors[2]);
		g.fillRect( dataMap.get( "x_pos3" ), dataMap.get( "y_pos3" ) , dotSize, dotSize);

...
public class CommandLoader029 implements CommandLoader{
	static Logger logger = Logger.getLogger(CommandLoader029.class);
	
	private String move_page [][] ;
	private String parameters [] ;
	
	public CommandLoader029( String [][] move_page, String [] parameters ){

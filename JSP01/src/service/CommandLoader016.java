...
public class CommandLoader016 implements CommandLoader{
	static Logger logger = Logger.getLogger(CommandLoader016.class);
	
	private String move_page [][] ;
	private String parameters [] ;
	
	public CommandLoader016( String [][] move_page, String [] parameters ){

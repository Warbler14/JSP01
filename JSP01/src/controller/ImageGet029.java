...
import service.CommandLoader029;
import service_interface.Page;

/**
 *  http://localhost:8081/JSP01/drawPendulum?cmd=inputPage
 */



@WebServlet("/drawPendulum")
public class ImageGet029 extends HttpServlet {
private static final long serialVersionUID = 1L;
	...
	public void init() throws ServletException{
		logger.info("init");
		service = new CommandLoader029( MOVE_PAGE, PARAMETERS);
